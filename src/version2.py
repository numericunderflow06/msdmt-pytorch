...
for train_index, test_index in kfold.split(U, y1):
    ...
    model = MSDMT(input_dim_portrait=portrait_input_dim, portrait_dim=portrait_dim, behavior_num=behavior_num, behavior_emb_dim=behavior_emb_dim, maxlen=maxlen, timestep=timestep, behavior_dim=behavior_dim, network_dim=network_dim, dropout=dropout)
